...
void Vtop_tinyfarm_sim_fixed___024root___eval_triggers_vec__ico(Vtop_tinyfarm_sim_fixed___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___eval_triggers_vec__ico\n"); );
...
bool Vtop_tinyfarm_sim_fixed___024root___trigger_anySet__ico(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___trigger_anySet__ico\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
void Vtop_tinyfarm_sim_fixed___024root___ico_sequent__TOP__0(Vtop_tinyfarm_sim_fixed___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___ico_sequent__TOP__0\n"); );
    Vtop_tinyfarm_sim_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
void Vtop_tinyfarm_sim_fixed___024root___eval_ico(Vtop_tinyfarm_sim_fixed___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___eval_ico\n"); );
    Vtop_tinyfarm_sim_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VicoTriggered[0U])) {
        Vtop_tinyfarm_sim_fixed___024root___ico_sequent__TOP__0(vlSelf);
    }
}
...
bool Vtop_tinyfarm_sim_fixed___024root___eval_phase__ico(Vtop_tinyfarm_sim_fixed___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___eval_phase__ico\n"); );
    Vtop_tinyfarm_sim_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ __VicoExecute;
    // Body
    Vtop_tinyfarm_sim_fixed___024root___eval_triggers_vec__ico(vlSelf);
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
        Vtop_tinyfarm_sim_fixed___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
    }
#endif
    __VicoExecute = Vtop_tinyfarm_sim_fixed___024root___trigger_anySet__ico(vlSelfRef.__VicoTriggered);
    if (__VicoExecute) {
        Vtop_tinyfarm_sim_fixed___024root___eval_ico(vlSelf);
    }
    return (__VicoExecute);
}

void Vtop_tinyfarm_sim_fixed___024root___eval_triggers_vec__act(Vtop_tinyfarm_sim_fixed___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___eval_triggers_vec__act\n"); );
    Vtop_tinyfarm_sim_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
bool Vtop_tinyfarm_sim_fixed___024root___trigger_anySet__act(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___trigger_anySet__act\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
void Vtop_tinyfarm_sim_fixed___024root___nba_sequent__TOP__0(Vtop_tinyfarm_sim_fixed___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___nba_sequent__TOP__0\n"); );
    Vtop_tinyfarm_sim_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*7:0*/ top_tinyfarm_sim__DOT__fr;
    ...
    if (vlSelfRef.sim_rst) {
        ...
        __Vdly__top_tinyfarm_sim__DOT__frames_until_tick = 0x001dU;
...
void Vtop_tinyfarm_sim_fixed___024root___eval_nba(Vtop_tinyfarm_sim_fixed___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___eval_nba\n"); );
    Vtop_tinyfarm_sim_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VnbaTriggered[0U])) {
        Vtop_tinyfarm_sim_fixed___024root___nba_sequent__TOP__0(vlSelf);
    }
}

void Vtop_tinyfarm_sim_fixed___024root___trigger_orInto__act_vec_vec(VlUnpacked<QData/*63:0*/, 1> &out, const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___trigger_orInto__act_vec_vec\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
bool Vtop_tinyfarm_sim_fixed___024root___eval_phase__act(Vtop_tinyfarm_sim_fixed___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___eval_phase__act\n"); );
    Vtop_tinyfarm_sim_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vtop_tinyfarm_sim_fixed___024root___eval_triggers_vec__act(vlSelf);
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
        Vtop_tinyfarm_sim_fixed___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
    }
#endif
    Vtop_tinyfarm_sim_fixed___024root___trigger_orInto__act_vec_vec(vlSelfRef.__VnbaTriggered, vlSelfRef.__VactTriggered);
    return (0U);
}

void Vtop_tinyfarm_sim_fixed___024root___trigger_clear__act(VlUnpacked<QData/*63:0*/, 1> &out) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___trigger_clear__act\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
bool Vtop_tinyfarm_sim_fixed___024root___eval_phase__nba(Vtop_tinyfarm_sim_fixed___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___eval_phase__nba\n"); );
    Vtop_tinyfarm_sim_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ __VnbaExecute;
    // Body
    __VnbaExecute = Vtop_tinyfarm_sim_fixed___024root___trigger_anySet__act(vlSelfRef.__VnbaTriggered);
    if (__VnbaExecute) {
        Vtop_tinyfarm_sim_fixed___024root___eval_nba(vlSelf);
        Vtop_tinyfarm_sim_fixed___024root___trigger_clear__act(vlSelfRef.__VnbaTriggered);
    }
    return (__VnbaExecute);
}

void Vtop_tinyfarm_sim_fixed___024root___eval(Vtop_tinyfarm_sim_fixed___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___eval\n"); );
    Vtop_tinyfarm_sim_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vtop_tinyfarm_sim_fixed___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("top_tinyfarm_sim_fixed.sv", 4, "", "DIDNOTCONVERGE: Input combinational region did not converge after '--converge-limit' of 100 tries");
        }
        __VicoIterCount = ((IData)(1U) + __VicoIterCount);
        vlSelfRef.__VicoPhaseResult = Vtop_tinyfarm_sim_fixed___024root___eval_phase__ico(vlSelf);
    ...
    do {
...
#ifdef VL_DEBUG
            Vtop_tinyfarm_sim_fixed___024root___dump_triggers__act(vlSelfRef.__VnbaTriggered, "nba"s);
#endif
            VL_FATAL_MT("top_tinyfarm_sim_fixed.sv", 4, "", "DIDNOTCONVERGE: NBA region did not converge after '--converge-limit' of 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vtop_tinyfarm_sim_fixed___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("top_tinyfarm_sim_fixed.sv", 4, "", "DIDNOTCONVERGE: Active region did not converge after '--converge-limit' of 100 tries");
            }
            vlSelfRef.__VactIterCount = ((IData)(1U) 
                                         + vlSelfRef.__VactIterCount);
            vlSelfRef.__VactPhaseResult = Vtop_tinyfarm_sim_fixed___024root___eval_phase__act(vlSelf);
        } while (vlSelfRef.__VactPhaseResult);
        vlSelfRef.__VnbaPhaseResult = Vtop_tinyfarm_sim_fixed___024root___eval_phase__nba(vlSelf);
    } while (vlSelfRef.__VnbaPhaseResult);
}

#ifdef VL_DEBUG
void Vtop_tinyfarm_sim_fixed___024root___eval_debug_assertions(Vtop_tinyfarm_sim_fixed___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_tinyfarm_sim_fixed___024root___eval_debug_assertions\n"); );
    Vtop_tinyfarm_sim_fixed__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
